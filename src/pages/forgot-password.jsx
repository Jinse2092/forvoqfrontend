...
const ForgotPassword = () => {
  ...
  const handleRequestOtp = async (e) => {
    ...
    try {
      ...
      const checkRes = await fetch('forwokbackend-1.onrender.com/api/users');
      ...
      const response = await fetch('forwokbackend-1.onrender.com/api/forgot-password/request-otp', {
        method: 'POST',
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('forwokbackend-1.onrender.com/api/forgot-password/verify-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleResetPassword = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('forwokbackend-1.onrender.com/api/forgot-password/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
