...
const PaymentsPanel = () => {
  ...
  useEffect(() => {
    if (currentUser?.role === 'merchant' && currentUser?.id) {
      fetch(`https://app.forvoq.com/api/received-payments?merchantId=${currentUser.id}`)
        .then(res => res.json())
        .then(data => setReceivedPayments(data));
    } else if (currentUser?.role === 'admin') {
      fetch('https://app.forvoq.com/api/received-payments')
        .then(res => res.json())
    ...
    fetch('https://app.forvoq.com/api/orders')
      .then(res => res.json())
  ...
  useEffect(() => {
    ...
    Promise.all(ids.map(id =>
      fetch(`https://app.forvoq.com/api/packingfees/${id}`)
